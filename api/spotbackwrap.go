...
func NewSpotBackExchange(opt constant.Option) (Exchange, error) {
	exchange := NewExchangeBackWrap(opt)
...
// SetTradeTypeMap ...
func (e *ExchangeBackWrap) SetTradeTypeMap(key int, val string) {
	e.tradeTypeMap[key] = val
}

// SetTradeTypeMapReverse ...
func (e *ExchangeBackWrap) SetTradeTypeMapReverse(key string, val int) {
	e.tradeTypeMapReverse[key] = val
}

// NewExchangeBackWrap create an exchange struct of futureExchange.com
func NewExchangeBackWrap(opt constant.Option) *ExchangeBackWrap {
	futureExchange := ExchangeBackWrap{
		stockTypeMap: map[string]goex.CurrencyPair{
...
func (e *ExchangeBackWrap) Init(opt constant.Option) error {
...
func (e *ExchangeBackWrap) SetStockTypeMap(m map[string]goex.CurrencyPair) {
	e.stockTypeMap = m
}

// GetStockTypeMap get stock type map
func (e *ExchangeBackWrap) GetStockTypeMap() map[string]goex.CurrencyPair {
	return e.stockTypeMap
}

// GetDepth get depth from exchange
func (e *ExchangeBackWrap) GetDepth() (*constant.Depth, error) {
...
func (e *ExchangeBackWrap) GetPosition() ([]constant.Position, error) {
	return nil, fmt.Errorf("spot without position")
}

// GetAccount get the account detail of this exchange
func (e *ExchangeBackWrap) GetAccount() (*constant.Account, error) {
...
func (e *ExchangeBackWrap) Buy(price, amount string, msg string) (string, error) {
	var err error
...
func (e *ExchangeBackWrap) Sell(price, amount string, msg string) (string, error) {
	var err error
	var ord *constant.Order
	stockType := e.GetStockType()
...
func (e *ExchangeBackWrap) GetOrder(id string) (*constant.Order, error) {
...
func (e *ExchangeBackWrap) GetOrders() ([]constant.Order, error) {
...
func (e *ExchangeBackWrap) CancelOrder(orderID string) (bool, error) {
...
func (e *ExchangeBackWrap) GetTicker() (*constant.Ticker, error) {
