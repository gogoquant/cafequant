...
// FutureBackExchange the exchange struct of futureExchange.com
type FutureBackExchange struct {
	BaseExchange
...
// SetTradeTypeMap ...
func (e *FutureBackExchange) SetTradeTypeMap(key int, val string) {
...
func NewFutureBackExchange(opt constant.Option) *FutureBackExchange {
	futureExchange := FutureBackExchange{
		stockTypeMap: map[string]goex.CurrencyPair{
...
// ValidBuy ...
func (e *FutureBackExchange) ValidBuy() error {
	dir := e.GetDirection()
...
// ValidSell ...
func (e *FutureBackExchange) ValidSell() error {
	dir := e.GetDirection()
...
func (e *FutureBackExchange) Init(opt constant.Option) error {
...
func (e *FutureBackExchange) SetStockTypeMap(m map[string]goex.CurrencyPair) {
	e.stockTypeMap = m
}

// GetStockTypeMap get stock type map
func (e *FutureBackExchange) GetStockTypeMap() map[string]goex.CurrencyPair {
	return e.stockTypeMap
}

// Log print something to console
func (e *FutureBackExchange) Log(msgs ...interface{}) {
	e.logger.Log(constant.INFO, e.GetStockType(), 0.0, 0.0, msgs...)
}

// GetType get the type of this exchange
func (e *FutureBackExchange) GetType() string {
	return e.option.Type
}

// GetName get the name of this exchange
func (e *FutureBackExchange) GetName() string {
...
func (e *FutureBackExchange) depthA2U(depth *goex.Depth) *constant.Depth {
...
func (e *FutureBackExchange) GetPosition() interface{} {
	//stockType := e.GetStockType()
	//exchangeStockType, ok := e.stockTypeMap[stockType]
	//if !ok {
...
func (e *FutureBackExchange) positionA2U(positions []goex.FuturePosition) []constant.Position {
...
func (e *FutureBackExchange) GetMinAmount(stock string) float64 {
	return e.minAmountMap[stock]
}

// GetAccount get the account detail of this exchange
func (e *FutureBackExchange) GetAccount() interface{} {
	/*
...
func (e *FutureBackExchange) Buy(price, amount string, msg ...interface{}) interface{} {
	/*
		    var err error
			var openType int
			stockType := e.GetStockType()
...
func (e *FutureBackExchange) Sell(price, amount string, msg ...interface{}) interface{} {
	return nil
	/*
		    var err error
			var openType int
...
func (e *FutureBackExchange) GetOrder(id string) interface{} {
	return nil
	/*
...
// CompareOrders ...
func (e *FutureBackExchange) CompareOrders(lft, rht []constant.Order) bool {
...
func (e *FutureBackExchange) GetOrders() interface{} {
	return nil
	/*
		exchangeStockType, ok := e.stockTypeMap[e.GetStockType()]
		if !ok {
...
func (e *FutureBackExchange) orderA2U(orders []goex.FutureOrder) []constant.Order {
...
func (e *FutureBackExchange) GetTrades(params ...interface{}) interface{} {
	return nil
	/*
		exchangeStockType, ok := e.stockTypeMap[e.GetStockType()]
		if !ok {
...
// tradesA2U ...
func (e *FutureBackExchange) tradesA2U(APITraders []goex.Trade) []constant.Trader {
...
func (e *FutureBackExchange) CancelOrder(orderID string) interface{} {
	return nil
	/*
		exchangeStockType, ok := e.stockTypeMap[e.GetStockType()]
		if !ok {
...
func (e *FutureBackExchange) GetTicker() interface{} {
	return nil
	/*
		var nullTime time.Time
		exchangeStockType, ok := e.stockTypeMap[e.GetStockType()]
...
// tickerA2U ...
func (e *FutureBackExchange) tickerA2U(exTicker *goex.Ticker) *constant.Ticker {
	//force covert
...
func (e *FutureBackExchange) GetRecords(periodStr string) interface{} {
	return nil
	/*
	       exchangeStockType, ok := e.stockTypeMap[e.GetStockType()]
	   	var period int64 = -1
