...
// ExchangeGo interface
type ExchangeGo interface {
	Ready() error                                                  //设置mode
	IsBack() bool                                                  //is back exchange
	SetIO(mode string)                                             //设置IO
	GetIO() string                                                 //获取IO
	GetSubscribe()                                                 //获取订阅
	SetSubscribe(string, string) map[string]string                 //订阅
	...
	BackGetSymbols(market string) []string                                             //获取货币种类
	BackGetMarkets() []string                                                          //获取交易所种类
...
type Exchange interface {
	...
	GetRecords(periodStr, maStr string) interface{}            //返回交易所的最新K线数据列表
	SetContractType(contractType string)                       //设置合约周期
	GetContractType() string                                   //获取合约周期
	SetDirection(direction string)                             //设置交易方向
	GetDirection() string                                      //获取交易方向
