...
// CtpExchange the exchange struct of ctp
type CtpExchange struct {
	BaseExchange
	stockTypeMap        map[string]int
	stockTypeMapReverse map[int]string
...
const (
	...
	// marketFront ...
	marketFront = "tcp://180.168.146.187:10031" // "行情前置,SimNow的测试环境: tcp://180.168.146.187:10031")
	// tradeFront ...
	tradeFront = "tcp://180.168.146.187:10030" // "交易前置,SimNow的测试环境: tcp://180.168.146.187:10030")
)
