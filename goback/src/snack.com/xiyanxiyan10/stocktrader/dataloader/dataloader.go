...
type LowPrice interface {
	LowPrice() float64
}

// OpenPrice defines the handling otf the latest Price Information
type OpenPrice interface {
	OpenPrice() float64
}

// ClosePrice defines the handling otf the latest Price Information
type ClosePrice interface {
	ClosePrice() float64
}

// VolumeAmount ...
type VolumeAmount interface {
	VolumeAmount() int64
}
...
// ClosePrice returns the close price of the bar event.
func (b Bar) ClosePrice() float64 {
	return b.Close
}

// OpenPrice returns the close price of the bar event.
func (b Bar) OpenPrice() float64 {
	return b.Open
}

// HighPrice returns the close price of the bar event.
func (b Bar) HighPrice() float64 {
	return b.High
}

// LowPrice returns the close price of the bar event.
func (b Bar) LowPrice() float64 {
	return b.Low
}

// VolumeAmount returns the close price of the bar event.
func (b Bar) VolumeAmount() int64 {
	return b.Volume
}
