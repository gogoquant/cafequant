...
class TagService(BaseService):
    ...
    @tornado.gen.engine
    def get_list(self, user_id=None, title=None, pos=None, count=None, callback=None):
        '''检索文章分页列表, 根据时间排序'''
    ...
    def add(self, title, user_id, callback=None):
        ...
        new_tag_id = yield tornado.gen.Task(self.tag_m.insert, tag, upsert=True, safe=True)
        callback(new_tag_id)
