...
VUFORIA = [{"user_name": "xiyanxiyan10@hotmail.com",
...
#检索回调rpc
define("Search_CallBack_Exchange", default="search_callback",
       help="misaka search callback exchange")

#消息同步
# send message by search_sync exchange
define("Sync_Send_Data_Exchange", default="sync_send",
       help="Sync_Send_Data_Exchange")
define("Sync_Send_Data_Routing_Key", default="misaka_sync_db.data",
       help="Sync_Send_Data_Routing_Key")


define("Sync_Receive_Data_Exchange", default="sync_recive",
       help="Sync_Receive_Data_Exchange")
define("Sync_Receive_Data_Queue", default="misaka_sync_db_queue",
       help="Sync_Receive_Data_Queue")
define("Sync_Receive_Data_Routing_Key", default="misaka_sync_db.*",
       help="Sync_Receive_Data_Routing_Key")

#用户信息变更queue
define("User_Status_Exchange", default="user_status",
       help="user status exchange")
